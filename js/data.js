...
const PLACES = {
  ...
  "hotel-suiun": { n: "ריוקאן Suiun — לילה באונסן", en: "Hakone Suiun Ryokan", city: "האקונה", cat: "hotel",
    d: "לילה אחד 21–22.09 (₪1,942 · הוזמן ✔, Booking 6226984993). ⚠️ במייל האישור מ-3.4 כתוב צ׳ק-אין 22.09 ובאפליקציה 21–22 — לוודא מול Booking! ארוחת הערב הוזמנה ב-Gyunabe Ukon ביומוטו." },
  ...
  "hakkoku": { n: "סושי Hakkoku", en: "Hakkoku Ginza Sushi", city: "טוקיו", cat: "food", part: "ערב",
    d: "סושי אומקסה ברמה גבוהה — ארוחת הסיום. ⚠️ בקשת TABLEALL בוטלה (24.08) — טרם הוזמן. שימו לב: ¥46,000 לסועד!", book: "להזמין מחדש — TABLEALL / OMAKASE.IN" },
