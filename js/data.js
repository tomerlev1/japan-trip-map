...
const CATALOG = [
  ...
  { n: "מופע סומו", en: "Sumo Show Tokyo", city: "טוקיו", cat: "exp", klook: "https://shorturl.at/Y6Imk" },
  { n: "קרטינג ברחובות טוקיו", en: "Street Karting Tokyo", city: "טוקיו", cat: "exp", klook: "https://shorturl.at/ZVclF", note: "דרוש רישיון נהיגה בינלאומי!" },
  { n: "פארק הארי פוטר (Warner Bros)", en: "Warner Bros Studio Tour Tokyo Harry Potter", city: "טוקיו", cat: "exp", klook: "https://shorturl.at/jgbe9" },
  { n: "Shibuya Sky — תצפית גגות", en: "Shibuya Sky", city: "טוקיו", cat: "site", klook: "https://shorturl.at/pg7D6" },
  { n: "פארק סנריו (הלו קיטי)", en: "Sanrio Puroland", city: "טוקיו", cat: "exp", klook: "https://shorturl.at/dnKgP" },
  { n: "מוזיאון-אקווריום בגינזה", en: "Art Aquarium Museum Ginza", city: "טוקיו", cat: "site", klook: "https://shorturl.at/4Ql4o" },
  { n: "טוקיו דיסני-סי (ירד מהמסלול)", en: "Tokyo DisneySea", city: "טוקיו", cat: "exp", klook: "https://shorturl.at/BFd0u", note: "אם מתחשק להחזיר — יום שלם, שעה לפני פתיחה" },
  { n: "teamLab אוסקה", en: "teamLab Botanical Garden Osaka", city: "אוסקה", cat: "exp", klook: "https://shorturl.at/mDUBh" },
  { n: "סיור בעברית בטוקיו (סוזי)", en: "Tokyo", city: "טוקיו", cat: "exp", note: "קוד OMERINJAPAN — סיור עם סוזי, חיה ביפן 20+ שנה" },
  { n: "סיור אוכל בעברית באוסקה (לירן)", en: "Osaka", city: "אוסקה", cat: "exp", note: "קבוצות קטנות עד 8 — אווירה, אלכוהול והיסטוריה" },

  /* --- טוקיו: מסעדות --- */
  { n: "Kanazawa Maimon Sushi", en: "Kanazawa Maimon Sushi Tokyo", city: "טוקיו", cat: "food", note: "סושי מסוע — רשת איכותית" },
  { n: "Nemuro Hanamaru Ginza", en: "Kaitenzushi Nemuro Hanamaru Ginza", city: "טוקיו", cat: "food", note: "סושי מסוע איכותי" },
  { n: "Sushi Kenshin (אביסו)", en: "Sushi Kenshin Ebisu", city: "טוקיו", cat: "food", note: "אומקסה, אפשרי ללא פירות ים — להזמין מראש", book: true },
  { n: "Jikasei MENSHO", en: "Jikasei Mensho Shibuya", city: "טוקיו", cat: "food", note: "ראמן בשיבויה" },
  { n: "Ramen Break Beats", en: "Ramen Break Beats Meguro", city: "טוקיו", cat: "food", note: "ראמן" },
  { n: "Afuri", en: "Afuri Ramen Ebisu", city: "טוקיו", cat: "food", note: "ראמן יוזו — רשת מומלצת 🌱" },
  { n: "Bills Ginza", en: "Bills Ginza", city: "טוקיו", cat: "food", note: "ארוחת בוקר" },
  { n: "Blue Bottle Coffee", en: "Blue Bottle Coffee Tokyo", city: "טוקיו", cat: "food", note: "רשת קפה" },
  { n: "A Happy Pancake", en: "A Happy Pancake Omotesando", city: "טוקיו", cat: "food", note: "פנקייק פלאפי" },
  { n: "Flipper's שיבויה", en: "Flippers Shibuya", city: "טוקיו", cat: "food", note: "פנקייק פלאפי" },
  { n: "Micasadeco & Cafe", en: "Micasadeco Cafe Jingumae", city: "טוקיו", cat: "food", note: "פנקייק פלאפי" },
  { n: "BAM BI COFFEE", en: "Bam Bi Coffee Tokyo", city: "טוקיו", cat: "food", note: "פנקייק + קפה מעולה" },
  { n: "Verve Coffee Roasters", en: "Verve Coffee Roasters Shinjuku", city: "טוקיו", cat: "food", note: "בית קפה" },
  { n: "Nikuya no Daidokoro", en: "Nikuya no Daidokoro Shinjuku", city: "טוקיו", cat: "food", note: "יאקיניקו" },
  { n: "Han no Daidokoro Bettei", en: "Han no Daidokoro Bettei Shibuya", city: "טוקיו", cat: "food", note: "יאקיניקו" },
  { n: "WAGYU NIKUTARASHI", en: "Wagyu Yakiniku Nikutarashi Tokyo", city: "טוקיו", cat: "food", note: "יאקיניקו" },
  { n: "Jambo Hanare", en: "Jambo Hanare Tokyo", city: "טוקיו", cat: "food", note: "יאקיניקו" },
  { n: "GINZA STEAK", en: "Ginza Steak Chuo", city: "טוקיו", cat: "food", note: "טפניאקי" },
  { n: "Teppanyaki Akasaka", en: "Teppanyaki Akasaka Tokyo", city: "טוקיו", cat: "food", note: "טפניאקי" },
  { n: "NOBU Tokyo", en: "Nobu Tokyo", city: "טוקיו", cat: "food", note: "מערבית-יפנית — להזמין מראש", book: true },
  { n: "PST Roppongi", en: "Pizza Studio Tamaki Roppongi", city: "טוקיו", cat: "food", note: "פיצה" },
  { n: "pizza marumo", en: "Pizza Marumo Ebisu", city: "טוקיו", cat: "food", note: "פיצה" },
  { n: "Tír na nÓg", en: "Tir na nOg Bar Tokyo", city: "טוקיו", cat: "exp", note: "בר קוקטיילים" },
  { n: "Bar TRENCH", en: "Bar Trench Ebisu", city: "טוקיו", cat: "exp", note: "בר קוקטיילים" },
  { n: "THE MUSIC BAR CAVE", en: "The Music Bar Cave Shibuya", city: "טוקיו", cat: "exp", note: "בר רטרו" },
  { n: "A10 (בר סודי)", en: "A10 Bar Shibuya", city: "טוקיו", cat: "exp", note: "בר קוקטיילים סודי" },
  { n: "Crony (מישלן)", en: "Crony Nishiazabu", city: "טוקיו", cat: "food", note: "צרפתית מישלן — להזמין מראש", book: true },
  { n: "SÉZANNE (מישלן)", en: "Sezanne Tokyo", city: "טוקיו", cat: "food", note: "צרפתית מישלן — להזמין מראש", book: true },
  { n: "MAZ (מישלן)", en: "MAZ Tokyo", city: "טוקיו", cat: "food", note: "פרואנית מישלן — להזמין מראש", book: true },
  { n: "Kabi (מישלן)", en: "Kabi Meguro", city: "טוקיו", cat: "food", note: "יפנית מודרנית — להזמין מראש", book: true },

  /* --- קיוטו: מסעדות --- */
  { n: "Sushi Ishimatsu", en: "Sushi Ishimatsu Kyoto", city: "קיוטו", cat: "food", note: "סושי" },
  { n: "MoriMori Sushi", en: "Morimori Sushi Shijo Kawaramachi", city: "קיוטו", cat: "food", note: "סושי מסוע" },
  { n: "Sushi Kizaemon", en: "Sushi Kizaemon Kyoto", city: "קיוטו", cat: "food", note: "סושי" },
  { n: "Maruman", en: "Maruman Sushi Kyoto", city: "קיוטו", cat: "food", note: "סושי" },
  { n: "KYOTO ENGINE RAMEN", en: "Kyoto Engine Ramen", city: "קיוטו", cat: "food", note: "ראמן — אופציות צמחוניות 🌱" },
  { n: "Sugari", en: "Sugari Ramen Kyoto", city: "קיוטו", cat: "food", note: "ראמן" },
  { n: "Vegan Ramen UZU", en: "Vegan Ramen Uzu Kyoto", city: "קיוטו", cat: "food", note: "ראמן טבעוני 🌱" },
  { n: "Sabanji", en: "Sabanji Ramen Kyoto", city: "קיוטו", cat: "food", note: "ראמן בשרי" },
  { n: "Panel Cafe", en: "Panel Cafe Kyoto", city: "קיוטו", cat: "food", note: "פנקייק פלאפי" },
  { n: "Maccha House", en: "Maccha House Kyoto", city: "קיוטו", cat: "food", note: "מאצ'ה" },
  { n: ".common", en: "common cafe Kyoto", city: "קיוטו", cat: "food", note: "בית קפה" },
  { n: "Blue Bottle קיוטו", en: "Blue Bottle Coffee Kyoto", city: "קיוטו", cat: "food", note: "רשת קפה" },
  { n: "ACTUAL KYOTO", en: "Actual Kyoto cafe", city: "קיוטו", cat: "food", note: "בית קפה" },
  { n: "Gyūrakutei", en: "Yakiniku Gyurakutei Kyoto", city: "קיוטו", cat: "food", note: "יאקיניקו" },
  { n: "Hikiniku to Kome", en: "Hikiniku to Come Kyoto", city: "קיוטו", cat: "food", note: "קציצות וואגיו ואורז" },
  { n: "Burger Revolution", en: "Burger Revolution Kyoto", city: "קיוטו", cat: "food", note: "המבורגר וואגיו" },
  { n: "Itoh Dining", en: "Itoh Dining Kyoto Gion", city: "קיוטו", cat: "food", note: "סטייקים — יוקרתית" },
  { n: "MOTOI Gyoza", en: "Motoi Gyoza Kyoto", city: "קיוטו", cat: "food", note: "גיוזה מישלן" },
  { n: "koisus — קארי וטמפורה", en: "Curry Tempura Koisus Kyoto", city: "קיוטו", cat: "food", note: "קארי וטמפורה" },
  { n: "Pizzeria Marita", en: "Pizzeria Marita Kyoto", city: "קיוטו", cat: "food", note: "פיצה" },
  { n: "Bigoli", en: "Bigoli Kyoto", city: "קיוטו", cat: "food", note: "פסטה" },
  { n: "Chao Chao Gyoza", en: "Chao Chao Gyoza Shijo Kawaramachi", city: "קיוטו", cat: "food", note: "גיוזה" },
  { n: "music bar Beatle momo", en: "Music Bar Beatle Momo Kyoto", city: "קיוטו", cat: "exp", note: "בר רטרו" },
  { n: "Masuya Saketen", en: "Masuya Saketen Kyoto", city: "קיוטו", cat: "exp", note: "בר סאקה" },
  { n: "mixology bar Smooth", en: "Mixology Bar Smooth Kyoto", city: "קיוטו", cat: "exp", note: "בר קוקטיילים" },
  { n: "Hyotei (3 כוכבי מישלן)", en: "Hyotei Kyoto", city: "קיוטו", cat: "food", note: "קייסקי ~450 שנה — להזמין מראש", book: true },
  { n: "Tenjaku (מישלן)", en: "Tenjaku Tempura Kyoto", city: "קיוטו", cat: "food", note: "טמפורה עונתית — להזמין מראש", book: true },
  { n: "Kikunoi Honten (3 כוכבים)", en: "Kikunoi Honten Kyoto", city: "קיוטו", cat: "food", note: "קייסקי — להזמין מראש", book: true },
  { n: "Kōdaiji Jūgyūan (2 כוכבים)", en: "Kodaiji Jugyuan Kyoto", city: "קיוטו", cat: "food", note: "קייסקי — להזמין מראש", book: true },

  /* --- אוסקה: מסעדות --- */
  { n: "Sushi Sakaba Sashisu", en: "Sushi Sakaba Sashisu Osaka", city: "אוסקה", cat: "food", note: "סושי" },
  { n: "Daiki-suisan דוטונבורי", en: "Daiki Suisan Kaitenzushi Dotonbori", city: "אוסקה", cat: "food", note: "סושי מסוע" },
  { n: "Sushi Hayata", en: "Sushi Hayata Osaka", city: "אוסקה", cat: "food", note: "סושי" },
  { n: "Sanshin — אומקסה", en: "Sushi Sanshin Osaka", city: "אוסקה", cat: "food", note: "אומקסה — להזמין מראש", book: true },
  { n: "Ichiran נמבה", en: "Ichiran Namba Midosuji", city: "אוסקה", cat: "food", note: "ראמן — ללא חזיר" },
  { n: "OSAKA ENGINE RAMEN", en: "Osaka Engine Ramen", city: "אוסקה", cat: "food", note: "ראמן" },
  { n: "Kyushu Ramen Kio", en: "Kyushu Ramen Kio Dotonbori", city: "אוסקה", cat: "food", note: "ראמן אותנטי" },
  { n: "Mugito Mensuke", en: "Mugito Mensuke Osaka", city: "אוסקה", cat: "food", note: "ראמן מומלץ מישלן" },
  { n: "Ourlog coffee", en: "Ourlog Coffee Osaka", city: "אוסקה", cat: "food", note: "קפה ומאפה" },
  { n: "Brooklyn Roasting Co.", en: "Brooklyn Roasting Company Kitahama", city: "אוסקה", cat: "food", note: "קפה ומאפה" },
  { n: "GLITCH COFFEE", en: "Glitch Coffee Osaka", city: "אוסקה", cat: "food", note: "קפה ספשלטי" },
  { n: "CAFE TALES", en: "Cafe Tales Osaka", city: "אוסקה", cat: "food", note: "ארוחת בוקר" },
  { n: "Wagyu Teppanyaki OUSAKA", en: "Wagyu Teppanyaki Ousaka", city: "אוסקה", cat: "food", note: "טפניאקי יוקרתי — להזמין מראש", book: true },
  { n: "Matsusakagyu M Hanare", en: "Matsusakagyu Yakiniku M Hanare Namba", city: "אוסקה", cat: "food", note: "יאקיניקו" },
  { n: "KITAN HIBIKI", en: "Kitan Hibiki Yakiniku Steak Osaka", city: "אוסקה", cat: "food", note: "וואגיו / סטייק" },
  { n: "La Pizza Regalo", en: "La Pizza Napoletana Regalo Osaka", city: "אוסקה", cat: "food", note: "איטלקית" },
  { n: "Tempura Makino", en: "Tempura Makino Namba", city: "אוסקה", cat: "food", note: "טמפורה" },
  { n: "Yakitori Ichimatsu", en: "Yakitori Ichimatsu Osaka", city: "אוסקה", cat: "food", note: "יאקיטורי מומלץ מישלן" },
  { n: "Alto Tritone", en: "Alto Tritone Osaka", city: "אוסקה", cat: "food", note: "איטלקית קטנה" },
  { n: "Osteria La Cicerchia", en: "Osteria La Cicerchia Osaka", city: "אוסקה", cat: "food", note: "איטלקית מומלצת מישלן" },
  { n: "BAR Inc", en: "Bar Inc Osaka", city: "אוסקה", cat: "exp", note: "בר קוקטיילים" },
  { n: "Bar Nayuta", en: "Bar Nayuta Osaka", city: "אוסקה", cat: "exp", note: "בר קוקטיילים" },
  { n: "Bar N", en: "Bar N Osaka", city: "אוסקה", cat: "exp", note: "בר משפחתי" },
  { n: "Akashic Records", en: "Osaka Cocktail Library Akashic Records", city: "אוסקה", cat: "exp", note: "בר קוקטיילים" },
  { n: "La Cime (2 כוכבים)", en: "La Cime Osaka", city: "אוסקה", cat: "food", note: "צרפתית-יפנית — להזמין מראש", book: true },
  { n: "HAJIME (3 כוכבים)", en: "Hajime Osaka", city: "אוסקה", cat: "food", note: "גסטרונומיה — להזמין מראש", book: true },
  { n: "Koryu (2 כוכבים)", en: "Koryu Osaka", city: "אוסקה", cat: "food", note: "קייסקי — להזמין מראש", book: true },
  { n: "Tenjimbashi Aoki (2 כוכבים)", en: "Tenjimbashi Aoki Osaka", city: "אוסקה", cat: "food", note: "קייסקי — מקומות מוגבלים", book: true },
];
