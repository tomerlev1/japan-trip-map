...
const COORDS = {
  ...
  "gyunabe-ukon":        [35.22771, 139.09394],
  ...
  "sushi-kenshin":       [35.64585, 139.71724],
  ...
  "hotel-panviman":      [9.77889, 100.05542],
...
const PLACES = {
  ...
  "toriyaki-ohana": { n: "Toriyaki Ohana — יקיטורי", en: "Toriyaki Ohana Tokyo", city: "טוקיו", cat: "food",
    d: "יקיטורי אומקסה — הוזמן ✔ ל-23.09 ב-20:00 · 4 סועדים · דלפק · קורס טעימות (OMAKASE ‏I-IDX2PXCW) · בלי אבוקדו." },
  ...
  "marutomi": { n: "Yakiniku MARUTOMI", en: "Yakiniku Marutomi Kyoto", city: "קיוטו", cat: "food", part: "ערב",
    d: "יאקיניקו מעולה במחיר טוב. ⚠️ ההזמנה שנעשתה בטעות ל-16.09 בוטלה — להזמין מחדש ל-15.09 בערב (Tabelog, קורס ¥8,800)." },
  ...
  "usj": { n: "יוניברסל סטודיוס יפן", en: "Universal Studios Japan", city: "אוסקה", cat: "exp", part: "כל היום",
    d: "כרטיסים ✔ Klook ל-18.09: Studio Pass ×2 (GPU887846) + Express Pass 7 Minecart ×2 (JYT884006) · ₪1,565 שולם · להגיע שעה לפני הפתיחה! לקשר את הכרטיס לאפליקציית USJ לתפוס Timed Entry לנינטנדו-וורלד.",
  ...
  "hotel-suiun": { n: "ריוקאן Suiun — לילה באונסן", en: "Hakone Suiun Ryokan", city: "האקונה", cat: "hotel",
    d: "לילה אחד 21–22.09 ✔ (אומת מול Booking · ₪1,942 · אישור 6226984993) · צ׳ק-אין 14:00–18:00 · חדר עם אונסן פרטי בחוץ · ארוחת הערב הוזמנה ב-Gyunabe Ukon ביומוטו (19:00)." },
  "gyunabe-ukon": { n: "Gyunabe Ukon — ארוחת החתונה 🎉", en: "Gyunabe Ukon Hakone", city: "האקונה", cat: "food", part: "ערב",
    d: "הוזמן ✔ 21.09 ב-19:00 · 2 סועדים · מושב קאוואדוקו על הנהר · קורס Ukon ‏¥17,600 לאדם (פיקדון ¥38,720 שולם) · טל׳ 050-3160-4153 · איחור מעל 30 דק׳ מבטל את ההזמנה! מגורה: רכבת טוזאן ליומוטו ~40 דק׳." },
  ...
  "nikutarashi": { n: "WAGYU NIKUTARASHI", en: "Wagyu Yakiniku Nikutarashi Tokyo", city: "טוקיו", cat: "food", part: "ערב",
    d: "יאקיניקו ואגיו — ארוחת חג עם מיש וגינגי 🎉 הוזמן ✔ 11.09 ב-20:00 · 4 סועדים · קורס פרימיום ¥20,000 לאדם + 10% שירות (Tabelog ‏AZJWZFXMAL) · צמוד לתחנת יויוגי." },
  "sushi-atsuya": { n: "Sushi Atsuya", en: "Sushi Atsuya Osaka", city: "אוסקה", cat: "food", part: "ערב",
    d: "סושי אומקסה — ארוחת טעימות, ליד מגדל הרוקאס. הוזמן ✔ 17.09 ב-19:30 · 2 סועדים (אושר באפליקציה)." },
  "savoy": { n: "פיצה Savoy", en: "Savoy Azabujuban Pizza", city: "טוקיו", cat: "food", part: "ערב",
    d: "מהפיצות הטובות בטוקיו. הוזמן ✔ 12.09 ב-19:00 · 2 סועדים (אושר באפליקציה) — להגיע בזמן." },
  ...
  "hakkoku": { n: "סושי Hakkoku", en: "Hakkoku Ginza Sushi", city: "טוקיו", cat: "food", part: "ערב",
    d: "ירד מהתוכנית — בקשת TABLEALL בוטלה (¥46,000 לסועד); במקומו הוזמנה ארוחת הסיום ב-Sushi Kenshin באביסו." },
  "sushi-kenshin": { n: "Ebisu Sushi Kenshin", en: "Sushi Kenshin Ebisu Tokyo", city: "טוקיו", cat: "food", part: "ערב",
    d: "אומקסה באביסו — ארוחת הסיום 🎉 הוזמן ✔ 25.09 ב-20:00 · 2 סועדים · אפשר ללא פירות ים (אושר באפליקציה)." },
  ...
  "airport-dep": { n: "טיסה לתאילנד ✈️", en: "Haneda Airport", city: "טוקיו", cat: "transit", approx: true,
    d: "26.09 · מונית מהמלון הוזמנה ✔ לשעה 07:00 (₪153, Booking.com) · להיות בהנדה טרמינל 3 עד ~07:30 · המראה 10:35 ← נחיתה בקראבי 19:45 (Thai Airways דרך בנגקוק, אישור 9YRZ-3C3J) · הכרטיס האלקטרוני יישלח עד 24 שעות לפני." },
};
...
const DAYS = [
  { id: "d0", n: 0, date: "10.09", dow: "חמישי", city: "טוקיו", color: "#64748b",
    ...
    transit: "נחיתה בהנדה 22:20 (EK312) · מונית הוזמנה ✔ ל-22:20 ליורקוצ׳ו (₪198) — ⚠️ זו בדיוק שעת הנחיתה! לעדכן את האיסוף ל~23:15 (דרכון+מזוודות) או לוודא שהנהג עוקב אחרי הטיסה.",
  ...
  { id: "d1", n: 1, date: "11.09", dow: "שישי", city: "טוקיו", color: "#e11d48",
    ...
    hotel: "hotel-shiodome",
    stops: ["meiji-shrine", "takeshita-st", "omotesando", "onodera-omotesando", "hachiko", "sbux-tsutaya", "shibuya-parco", "nikutarashi"] },
  { id: "d2", n: 2, date: "12.09", dow: "שבת", city: "טוקיו", color: "#ea580c",
    ...
    hotel: "hotel-shiodome",
    stops: ["sensoji", "nakamise", "kappabashi", "ueno-park", "skytree", "savoy"] },
  ...
  { id: "d5", n: 5, date: "15.09", dow: "שלישי", city: "קיוטו", color: "#059669",
    ...
    hotel: "hotel-nohga",
    stops: ["kiyomizudera", "sannenzaka", "nishiki-market", "maikoya", "marutomi"] },
  { id: "d6", n: 6, date: "16.09", dow: "רביעי", city: "קיוטו", color: "#0d9488",
    ...
    hotel: "hotel-nohga",
    stops: ["fushimi-inari", "fushimi-castle", "gekkeikan", "shijo-dori", "teamlab-biovortex", "in-the-moon"] },
  { id: "d7", n: 7, date: "17.09", dow: "חמישי", city: "אוסקה", color: "#0891b2",
    ...
    stops: ["hotel-flag", "kaiyukan", "yodobashi-umeda", "umeda-sky", "sushi-atsuya"] },
  ...
  { id: "d11", n: 11, date: "21.09", dow: "שני", city: "האקונה", color: "#9333ea",
    ...
    sum: "בוקר נסיעה, אחה\"צ המוזיאון הפתוח וגני גורה, אונסן — ובערב ארוחת החתונה ב-Gyunabe Ukon על הנהר (הוזמן ✔ 19:00).",
    hotel: "hotel-suiun",
    transit: "שינקנסן שין-אוסקה←אודווארה ~3 שעות + רכבת/אוטובוס לגורה. לשלוח מזוודות לטוקיו מראש!",
    stops: ["osaka-station", "odawara-station", "openair-museum", "gora-park", "hotel-suiun", "gyunabe-ukon"] },
  ...
  { id: "d13", n: 13, date: "23.09", dow: "רביעי", city: "טוקיו", color: "#db2777",
    ...
    hotel: "hotel-shiodome",
    stops: ["roppongi-hills", "midtown-2121", "teamlab-borderless", "tokyo-tower", "toriyaki-ohana"] },
  ...
  { id: "d15", n: 15, date: "25.09", dow: "שישי", city: "טוקיו", color: "#92400e",
    ...
    sum: "בוקר טעימות בצוקיג'י, יום גינזה (ראמן מישלן!), teamLab Planets, וארוחת סיום ב-Sushi Kenshin באביסו (הוזמן ✔ 20:00).",
    hotel: "hotel-shiodome",
    stops: ["tsukiji", "x-coffee", "uniqlo-ginza", "mitsukoshi-ginza", "ginza-ramen", "nissan-ginzasix", "ginza-sand", "teamlab-planets", "sushi-kenshin", "akihabara"] },
...
Object.assign(PLACES, {
  "arr-kbv": { n: "נחיתה בקראבי ✈️", en: "Krabi International Airport", city: "קראבי", cat: "transit",
    d: "26.09 · נחיתה עם TG249 מבנגקוק ~19:45 (קבלה 1357764, bookaflight, קוד J3C-3YRZ9) · נהג פרטי הוזמן ✔ ל-20:00 (עודכן!) — 64 דק׳ נסיעה למלון (41 ק\"מ) · אחרי המכס: נקודת מפגש 1 בקפה Amazon (בינלאומי) או יציאה 15 (פנים־ארצי), שלט עם השם · Energy Infinittus ‎+66-83-871-3360 · ההעברה עודכנה ✔: 2 נוסעים, TG249 מקושרת למעקב (₪76.25)." },
  ...
  "ferry-samui-phangan": { n: "מעבורת לקופנגן ⛴", en: "Bangrak Pier Koh Samui", city: "קוסמוי", cat: "transit", approx: true,
    d: "01.10 · הטיסה נוחתת 14:50 — ההפלגה הנוחה: Lomprayah ממזח מאנאם (Pralarn) ב-16:30 ← תונג סאלה 17:00 (~15 דק׳ מהשדה למזח, צ׳ק-אין 30 דק׳ לפני). זו ההפלגה הנוחה האחרונה של היום! מתונג סאלה לאננטרה רסאננדה ~40 דק׳ בדרך הרים — לתאם העברה מול המלון מראש." },
  "hotel-panviman": { n: "Anantara Rasananda קופנגן", en: "Anantara Rasananda Koh Phangan Villas", city: "קופנגן", cat: "hotel",
    d: "01–06.10 · הוזמן ✔ (Agoda, אישור 22.08) · הוחלף מ-Panviman — וילות על חוף תונג נאי פאן נוי · ~₪5,742 (฿63,237), חיוב אוטומטי 08.09 בכרטיס 5166." },
  "ferry-phangan-samui": { n: "מעבורת חזרה לסמוי ⛴", en: "Thong Sala Pier Koh Phangan", city: "קופנגן", cat: "transit", approx: true,
    d: "06.10 · מומלץ: לצאת מהאננטרה ~09:15 (45 דק׳ לתונג סאלה), הפלגת Seatran/Lomprayah ב-10:30 ← מזח בנגרק ~11:05, ומשם 10 דק׳ להאנסר · לקנות כרטיסים מראש ולתאם הסעה מול המלון." },
  ...
  "bkk-airport": { n: "בנגקוק ← ישראל ✈️", en: "Suvarnabhumi Airport Bangkok", city: "בנגקוק", cat: "transit",
    d: "14.10 · אל-על LY82 המראה 23:55 ← נתב\"ג 06:45 (PNR 7P8C5Y) · איסוף מהמלון ✔ 20:20 (MPV, וואוצ׳ר 3WDN4P-2), בשדה ~21:15 · צ׳ק-אין אונליין 24 שעות לפני עם 7P8C5Y · כבודה: מזוודה 23 ק\"ג + טרולי 8 ק\"ג + פריט אישי לנוסע · לוודא שעה 48–72 שעות לפני." },
...
DAYS.push(
  { id: "t1", nights: 2, ln: "קראבי", n: 17, c: "TH", label: "קראבי · 26–28.09", short: "קראבי א׳", date: "26–28.09", dfrom: "26.09", dto: "27.09",
    ...
    hotel: "hotel-tubkaak",
    transit: "נהג פרטי הוזמן ✔ לשעה 20:00 — ~64 דק׳ נסיעה למלון (וואוצ׳ר JKX4NN-1).",
  ...
  { id: "t3", nights: 5, ln: "קופנגן", n: 19, c: "TH", label: "קופנגן · 01–06.10", short: "קופנגן", date: "01–06.10", dfrom: "01.10", dto: "05.10",
    city: "קופנגן", color: "#15803d", title: "Anantara Rasananda קופנגן",
    sum: "טיסה קצרה לסמוי, מעבורת לקופנגן — 5 לילות באננטרה רסאננדה על חוף תונג נאי פאן נוי.",
...
const CATALOG = [
  ...
  { n: "Luna Lounge — תונג נאי פאן", en: "Luna Lounge Thong Nai Pan Noi", city: "קופנגן", cat: "food", k: "other", ll: [9.77668, 100.05363], src: "טריפאדוויזר: מהמובילות בקופנגן", note: "פיוז'ן תאילנדי-צרפתי · 5 דק' הליכה מהאננטרה" },
...
const JA = {
  ...
  "sushi-kenshin": { n: "恵比寿 鮨 謙心", a: "東京都渋谷区恵比寿2-8-13 KHビル 1F" },
  ...
  "gyunabe-ukon": { n: "牛鍋 右近", a: "神奈川県足柄下郡箱根町湯本茶屋185-5" },
...
const FLIGHTS = [
  { r: "תל אביב ← טוקיו (הנדה)", d: "09.09 · EK2168 ‏22:50 ← דובאי · EK312 ← הנדה 10.09 ‏22:20", note: "אמירטס, קונקשן 4:05 · PNR GVFM4N · מזוודה 30 ק\"ג + טרולי 7 ק\"ג · שולם ₪11,902 (קבלה 20836994, כולל החזור) · ⚠️ המונית הוזמנה ל-22:20 — בדיוק שעת הנחיתה! לעדכן ל~23:15 או לוודא שהנהג עוקב אחרי הטיסה" },
  { r: "טוקיו ← קראבי (דרך בנגקוק)", d: "26.09 · ‏10:35←19:45", note: "אישור BookAFlight ‏9YRZ-3C3J (קבלה 1357764) · $345 לנוסע · כרטיס אלקטרוני עד 24 שעות לפני · מונית לשדה 07:00 ✔ · נהג בקראבי 20:00 ✔ (2 נוסעים, TG249 מקושרת)" },
  ...
  { r: "בנגקוק ← תל אביב", d: "14.10 · LY82 · ‏23:55←06:45", note: "אל-על · PNR 7P8C5Y · מזוודה 23 ק\"ג + טרולי 8 ק\"ג לנוסע · איסוף מהמלון 20:20 ✔ (3WDN4P-2)" },
];
...
const SCHED = {
  ...
  d1: { "meiji-shrine": "08:45–10:00", "takeshita-st": "10:15–11:15", "omotesando": "11:15–12:15",
        ...
        "shibuya-parco": "15:30–17:30", "nikutarashi": "20:00–22:00" },
  d2: { "sensoji": "07:30–08:45", "nakamise": "08:45–09:45", "kappabashi": "10:00–11:15",
        "ueno-park": "11:45–13:30", "skytree": "16:30–18:15", "savoy": "19:00–21:00" },
  ...
  d6: { "fushimi-inari": "07:00–09:30", "fushimi-castle": "09:50–10:35", "gekkeikan": "11:00–12:00",
        "shijo-dori": "13:00–15:00", "teamlab-biovortex": "15:15–17:15", "in-the-moon": "17:45–19:30" },
  d7: { "hotel-flag": "11:30–12:00", "kaiyukan": "13:00–15:30", "yodobashi-umeda": "16:00–17:15",
        "umeda-sky": "17:15–18:50", "sushi-atsuya": "19:30–21:30" },
  d8: { "usj": "07:15–21:00" },
  ...
  d11: { "osaka-station": "08:00–08:30", "odawara-station": "11:00–11:30", "openair-museum": "13:30–15:45",
         "gora-park": "16:00–17:00", "hotel-suiun": "17:00–18:10", "gyunabe-ukon": "19:00–21:00" },
  ...
  d15: { "tsukiji": "08:00–10:00", "x-coffee": "10:00–10:30", "uniqlo-ginza": "11:00–12:00",
         ...
         "ginza-sand": "15:00–15:30", "teamlab-planets": "16:30–18:30", "sushi-kenshin": "20:00–22:00", "akihabara": "22:15–23:00" },
  d16: { "airport-dep": "מונית 07:00 · בטרמינל 07:30" },
  t1: { "arr-kbv": "נחיתה 19:45 · נהג 20:00", "hotel-tubkaak": "מ-21:15" },
