...
const PLACES = {
  ...
  "nikutarashi": { n: "WAGYU NIKUTARASHI", en: "Wagyu Yakiniku Nikutarashi Tokyo", city: "טוקיו", cat: "food", part: "ערב",
    d: "יאקיניקו ואגיו — ארוחת חג עם מיש וגינגי 🎉 צמוד לתחנת יויוגי.", book: "להזמין מראש" },
...
Object.assign(PLACES, {
  "arr-kbv": { n: "נחיתה בקראבי ✈️", en: "Krabi International Airport", city: "קראבי", cat: "transit",
    d: "26.09 · נחיתה עם TG249 מבנגקוק ~19:45 (קבלה 1357764, bookaflight, קוד J3C-3YRZ9) · נהג פרטי הוזמן ✔ ל-20:00 (עודכן!) — 64 דק׳ נסיעה למלון (41 ק\"מ) · אחרי המכס: נקודת מפגש 1 בקפה Amazon (בינלאומי) או יציאה 15 (פנים־ארצי), שלט עם השם · Energy Infinittus ‎+66-83-871-3360 · הוואוצ׳ר רשום על נוסע אחד — לוודא שהרכב מספיק לשניים + מזוודות." },
...
const FLIGHTS = [
  ...
  { r: "טוקיו ← קראבי (דרך בנגקוק)", d: "26.09 בבוקר · המשך TG249 לקראבי", note: "קבלה 1357764 · bookaflight (J3C-3YRZ9) · $345 לנוסע · מונית לשדה 07:00 ✔ (₪153) · נהג בקראבי 20:00 ✔ (JKX4NN-1)" },
